...
export default function Modal({
  ...
  return (
    ...
    >
      ...
      {/* modal */}
      <div
        className={`relative z-10 w-full max-w-lg rounded-2xl bg-white shadow-2xl transform transition duration-500 ${isOpen ? "translate-y-0 opacity-100" : "translate-y-full opacity-0"}`}
      >
        {/* header */}
